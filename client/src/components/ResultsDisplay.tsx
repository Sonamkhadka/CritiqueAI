      ...
      <Card className="overflow-hidden">
        <CardHeader className="border-b border-gray-100 bg-gradient-to-r from-gray-50 to-white">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            <div>
              <CardTitle className="text-xl font-semibold text-gray-900 flex items-center font-arvo">
              ...
              <Card className="border border-gray-200">
                <CardHeader className="pb-2 bg-gray-50">
                  <div className="flex items-center">
                    ...
                    <CardTitle className="text-base font-medium text-gray-800 font-arvo">Main Claim</CardTitle>
                    <TooltipProvider>
                      <Tooltip>
              ...
              <Card className="border border-gray-200">
                <CardHeader className="pb-2 bg-gray-50">
                  <div className="flex items-center">
                    ...
                    <CardTitle className="text-base font-medium text-gray-800 font-arvo">Supporting Premises</CardTitle>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="ml-1 cursor-help">
              ...
              <Card className="border border-gray-200">
                <CardHeader className="pb-2 bg-gray-50">
                  <div className="flex items-center">
                    ...
                    <CardTitle className="text-base font-medium text-gray-800 font-arvo">Emotional Tone Analysis</CardTitle>
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <span className="ml-1 cursor-help">
                ...
                <Card className="border border-gray-200">
                  <CardHeader className="pb-2 bg-gray-50">
                    <div className="flex items-center">
                      ...
                      <CardTitle className="text-base font-medium text-gray-800 font-arvo">Logical Fallacies Detected</CardTitle>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="ml-1 cursor-help">
                ...
                <Card className="border border-gray-200">
                  <CardHeader className="pb-2 bg-gray-50">
                    <div className="flex items-center">
                      ...
                      <CardTitle className="text-base font-medium text-gray-800 font-arvo">Critical Evaluation</CardTitle>
                      <TooltipProvider>
                        <Tooltip>
                          <TooltipTrigger asChild>
                            <span className="ml-1 cursor-help">
              ...
              {result.counterArguments && result.counterArguments.length > 0 && (
                <Card className="border border-gray-200">
                  <CardHeader className="pb-2 bg-gray-50">
                    <div className="flex items-center">
                      <MessageSquareQuote className="w-5 h-5 text-primary mr-2" />
                      <CardTitle className="text-base font-medium text-gray-800 font-arvo">
