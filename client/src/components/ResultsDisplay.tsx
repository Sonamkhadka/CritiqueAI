      ...
      <Card className="overflow-hidden">
        <CardHeader className="border-b border-gray-100">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <Tabs defaultValue="deepseek" className="w-auto">
          ...
          <div className="flex items-center justify-between mb-4">
            ...
            {result && (
              <div className="flex items-center space-x-2">
                <div className="rounded px-3 py-1 text-xs text-white font-medium bg-primary">
                  ...
                  <div className="space-y-2">
                    {result.fallacies.map((fallacy, index) => (
                      <div key={index} className="bg-gray-50 p-3 rounded-md border border-gray-200">
                        ...
                        <p className="text-sm text-gray-700 mt-1">{fallacy.explanation}</p>
                      </div>
                    ))}
                  </div>
                </div>
              ...
              {result.structureMap && (
                <div>
                  ...
                  <div className="bg-gray-50 p-3 rounded-md border border-gray-200">
                    <pre className="text-xs text-gray-700 whitespace-pre-wrap">{result.structureMap}</pre>
                  </div>
                </div>
              )}
